                ...
                <div className="about-me__container">
                    ...
                    <div className="about-me__subcontainer">
                        ...
                        <ul className="techs__list about-me__list">
                            <li><Link className="main__links about-me__links link-effect" to={{pathname: "https://github.com/bodjanja"}}>Telegram</Link></li>
                            <li><Link className="main__links about-me__links link-effect" to={{pathname: "https://github.com/bodjanja"}}>GitHub</Link></li>
                        </ul>
                    </div>
                </div>
                <Portfolio />
